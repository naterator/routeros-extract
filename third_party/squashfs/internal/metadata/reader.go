...
func (r *Reader) advance() error {
	...
	if realSize > decompress.MaxMetadataSize {
		return fmt.Errorf("SquashFS metadata block is %d bytes, maximum is %d", realSize, decompress.MaxMetadataSize)
	}
	...
	r.dat, err = decompress.Decode(r.d, r.dat, decompress.MaxMetadataSize)
	return err
}
