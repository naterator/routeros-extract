...
var otherFiles = []testFile{
	...
	{
		// 64 KiB + 1 byte crosses the input-buffer, uncompressed LZMA2
		// chunk, and dictionary boundaries without a megabyte fixture.
		file:   "random-64k-plus-1.xz",
		md5sum: "3e77d7af241f12923824ac98a180a676",
		err:    nil,
	},
	{
		file:   "zeros-100mb.xz",
